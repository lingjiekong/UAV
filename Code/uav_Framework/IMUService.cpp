...
/*----------------------------- Pin Function Layout -----------------------*/
// Motor PWM output: PD3 --
// Relayin Digital ouput: PD4 --
// Relayout Digital output: PD5 --
// DM Muscle wire actuator output: PD6 --
// Position Digital input: PD7 --
// DMUnlcok Switch input: PD8 --
...
bool InitIMUService ( uint8_t Priority )
{
  ...
  //Serial.begin(115200);
  Serial.begin(115200); // changed By Davide for test
